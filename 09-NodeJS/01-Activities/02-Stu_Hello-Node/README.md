...
* As a developer, I want to make a program that accepts a string as an input and logs it to the terminal. (Note: The string is part of the program, it is not inputed from a user.)
